...
if [ -f videos/VaultGatePitch.mp4 ]; then
  ffmpeg -i videos/VaultGatePitch.mp4 -t $ANIM_DURATION -c copy -f mp4 videos/VaultGatePitch.mp4.tmp && \
    mv videos/VaultGatePitch.mp4.tmp videos/VaultGatePitch.mp4 && \
